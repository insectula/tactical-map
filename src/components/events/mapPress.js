...
const useLongPress = (
  ...
  return {
    ...
    onMouseUp: e => longPressTriggered ? clear(e, false) : clear(e),
    onMouseLeave: e => started && start(e, false),
   // onMouseMove: e => started && start(e, false),
   // onTouchMove: e => started && start(e, false),
    onTouchEnd: e => longPressTriggered ? clear(e, false) : clear(e),
  };
};
